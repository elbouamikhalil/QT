...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Experience_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Experience_t qt_meta_stringdata_Experience = {
    {
QT_MOC_LITERAL(0, 10) // "Experience"
...
const QMetaObject Experience::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Experience.offsetsAndSize,
    qt_meta_data_Experience,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Experience_t
, QtPrivate::TypeAndForceComplete<Experience, std::true_type>
